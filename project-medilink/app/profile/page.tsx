    ...
    >
      ...
      <div className="bg-white p-8 shadow-xl rounded-lg w-full max-w-md flex flex-col items-center text-black mt-24">
        ...
        <div className="text-gray-700 text-lg w-full text-left space-y-3 mt-6 border-t border-gray-300 pt-4">
          <p><strong className="text-[#00BCD4]">First Name:</strong> {user?.firstName}</p>
          <p><strong className="text-[#00BCD4]">Last Name:</strong> {user?.lastName}</p>
          <p><strong className="text-[#00BCD4]">Email:</strong> {user?.email}</p>
          <p><strong className="text-[#00BCD4]">Gender:</strong> {user?.gender || "Not Set"}</p>
          <p><strong className="text-[#00BCD4]">Date of Birth:</strong> {user?.dob || "Not Set"}</p>
        </div>
      </div>
    </div>
  );
